...
public class PayloadNormalizerTest {
    ...
    public void spaceFromUrl(){
        ...
        Space spaceFromUrl = new PayloadNormalizer(Mockito.mock(CoreSvc.class), new Gson()).getSpaceFromUrl("https://nexus.humanbrainproject.org/v0/data/cscs/core/file/v1.0.0/fc0a5034-2aba-4b55-94c8-78e92538ecc9");
    ...
    public void normalizePayload(){
        ...
        JsonLdDoc map = new Gson().fromJson(json, JsonLdDoc.class);
        ...
        payloadNormalizer = new PayloadNormalizer(mock, new Gson());
