...
//    @GetMapping("/{space}")
//    public Result<Space> getSpace(@PathVariable("space") String space) {
//        return null;
//    }
//
//    @DeleteMapping("/{space}")
//    public void deleteSpace(@PathVariable("space") String space) {
//
//    }
//
//    @PutMapping("/{space}")
//    public void createSpace(@PathVariable("space") String space) {
//
//    }
//
//    @GetMapping("/{space}/users")
//    public PaginatedResult<User> getUsersForSpace(@PathVariable("space") String space, @RequestParam(value = "role", required = false) SpacePermissionGroup role, PaginationParam paginationParam) {
//        return null;
//    }
//
//
//    @PutMapping("/{space}/users/{userId}/roles/{role}")
//    public void addUserToSpace(@PathVariable("space") String space, @PathVariable("userId") String userId, @PathVariable("role") SpacePermissionGroup role) {
//
//    }
//
//    @DeleteMapping("/{space}/users/{userId}/roles/{role}")
//    public void removeUserFromSpace(@PathVariable("space") String space, @PathVariable("userId") String userId, @PathVariable("role") SpacePermissionGroup role) {
//
//    }
