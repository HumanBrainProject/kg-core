...
import eu.ebrains.kg.core.api.common.Queries;
 ...
 */
@RestController
@RequestMapping(Version.CURRENT +"/queries")
public class QueriesV3Beta extends Queries {
    ...
    public QueriesV3Beta(CoreQueryController queryController, AuthContext authContext, JsonLd.Client jsonLd, IdsController ids) {
        super(queryController, authContext);
        this.jsonLd = jsonLd;
        this.ids = ids;
    }
