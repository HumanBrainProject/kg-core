...
import eu.ebrains.kg.core.api.common.Instances;
...
public class InstancesV3Beta extends Instances {
    ...
    public InstancesV3Beta(CoreInstanceController instanceController, Release.Client release, AuthContext authContext, GraphDBInstances.Client graphDBInstances, IdsController idsController, VirtualSpaceController virtualSpaceController, JsonLd.Client jsonLd) {
        super(jsonLd, idsController, instanceController);
    ...
    @Operation(summary = "Get the scope for the instance by its KG-ID")
    ...
    @Operation(summary = "Get the neighborhood for the instance by its KG-ID")
