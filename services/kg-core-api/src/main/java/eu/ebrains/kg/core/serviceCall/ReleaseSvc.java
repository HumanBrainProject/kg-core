...
@Component
public class ReleaseSvc {
    private final ServiceCall serviceCall;
    private final AuthContext authContext;

    public ReleaseSvc(ServiceCall serviceCall, AuthContext authContext) {
        this.serviceCall = serviceCall;
        this.authContext = authContext;
    }

    private static final String RELEASE_ENDPOINT = "http://kg-releasing/releases/";
