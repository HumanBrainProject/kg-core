...
import eu.ebrains.kg.query.serviceCall.GraphDBAsyncSvc;
import eu.ebrains.kg.query.serviceCall.GraphDBSyncSvc;
...
public class Queries {
    ...
    private final GraphDBSyncSvc graphDBSyncSvc;

    private final GraphDBAsyncSvc graphDBAsyncSvc;

    private final PermissionSvc permissionSvc;

    public Queries(Gson gson, GraphDBSyncSvc graphDBSyncSvc, GraphDBAsyncSvc graphDBAsyncSvc, PermissionSvc permissionSvc) {
        this.gson = gson;
