...
package eu.ebrains.kg.primaryStore.config;
...
@Configuration
public class PrimaryStoreArangoConfiguration {

    @Bean
    @Qualifier("arangoBuilderForPrimaryStore")
    public ArangoDB.Builder producePrimaryStoreArangoDB(
    ...
    @Bean
    @Qualifier("primaryStoreDB")
    public ArangoDatabaseProxy producePrimaryStoreDb(@Qualifier("arangoBuilderForPrimaryStore") ArangoDB.Builder arangoDB) {
