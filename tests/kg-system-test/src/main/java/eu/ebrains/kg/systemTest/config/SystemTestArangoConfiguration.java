...
@Configuration
public class SystemTestArangoConfiguration {

    @Bean
    @Qualifier("arangoBuilderForSystemTest")
    public ArangoDB.Builder produceSystemTestArangoDB(
    ...
    @Bean
    @Qualifier("eventsTest")
    public ArangoDatabaseProxy produceTestEventsDb(@Qualifier("arangoBuilderForSystemTest") ArangoDB.Builder arangoDB) {
    ...
    @Bean
    @Qualifier("releasedMetaTest")
    public ArangoDatabaseProxy produceTestReleaseMetaDb(@Qualifier("arangoBuilderForSystemTest") ArangoDB.Builder arangoDB) {
