...
//        return Arrays.asList(new ApiKey("Client token", "Client-Authorization", "header"), new ApiKey("Client Id", "Client-Id", "header"), new ApiKey("Client secret", "Client-Secret", "header"), new ApiKey("Client Service Account Secret", "Client-ServiceAccount-Secret", "header"), new OAuthBuilder().name("HBP token").grantTypes(grantTypes()).build());
//    }
