...
public class ServiceCallWithClientSecret extends AbstractServiceCall {
    ...
    public ServiceCallWithClientSecret(@Qualifier("lb") WebClient.Builder loadBalancedWebClient, KeycloakSvc keycloakSvc, @Value("${eu.ebrains.kg.clientId}") String clientId, @Value("${eu.ebrains.kg.clientSecret}") String clientSecret) {
