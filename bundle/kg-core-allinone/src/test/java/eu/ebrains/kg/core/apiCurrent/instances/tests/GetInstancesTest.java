...
public class GetInstancesTest extends AbstractInstanceTest {
    ...
    private GetInstancesTest(TestContext testContext, InstancesV3Beta instances) {
        super(testContext, instances);
    }

    public static GetInstancesTest getInstancesWithExistingType(TestContext testContext, InstancesV3Beta instances){
        return new GetInstancesTest(testContext, instances);
    }


    public static GetInstancesTest getInstancesByType(TestContext testContext, InstancesV3Beta instances, String type){
        final GetInstancesTest test = getInstancesWithExistingType(testContext, instances);
        test.type = type;
        return test;
    }

    public static GetInstancesTest getInstancesByTypeAndSpace(TestContext testContext, InstancesV3Beta instances, String type, String space){
