...
public class ContributeToInstancePartialReplacementTest extends AbstractInstanceTest {
    ...
    public ContributeToInstancePartialReplacementTest(TestContext testContext, InstancesV3Beta instances) {
        super(testContext, instances);
        this.responseConfiguration = defaultResponseConfiguration;
    }

    public ContributeToInstancePartialReplacementTest(TestContext testContext, InstancesV3Beta instances, ExtendedResponseConfiguration responseConfiguration) {
        super(testContext, instances);
