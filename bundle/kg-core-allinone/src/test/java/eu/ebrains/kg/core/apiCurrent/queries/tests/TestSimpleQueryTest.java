...
package eu.ebrains.kg.core.apiCurrent.queries.tests;
...
import eu.ebrains.kg.core.api.current.QueriesV3Beta;
...
public class TestSimpleQueryTest extends AbstractTest {
    ...
    private final QueriesV3Beta queries;
    ...
    public TestSimpleQueryTest(TestContext testContext, QueriesV3Beta queries, InstancesV3Beta instances, ExposedStage stage, boolean release)  throws IOException
    {
        super(testContext);
