...
public class GetReleaseStatusTest extends AbstractInstanceTest {
    ...
    public GetReleaseStatusTest(TestContext testContext, InstancesV3Beta instances) {
    ...
    protected void run() {
        ...
        beAdmin();
        instances.contributeToInstancePartialReplacement(TestDataFactory.createTestData(smallPayload, 0, true), uuid, defaultResponseConfiguration);
        beInCurrentRole();
