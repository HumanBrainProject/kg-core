...
package eu.ebrains.kg.core.apiCurrent.types.test;
...
public class GetTypesTest extends AbstractTest {
    private final TypesV3Beta types;
    private final InstancesV3Beta instances;
    ...
    public GetTypesTest(TestContext testContext, SpaceName spaceName, boolean withProperties, boolean withIncomingLinks, boolean withCounts, TypesV3Beta types, InstancesV3Beta instances) {
        super(testContext);
