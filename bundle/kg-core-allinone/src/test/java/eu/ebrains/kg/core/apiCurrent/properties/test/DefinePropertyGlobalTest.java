...
package eu.ebrains.kg.core.apiCurrent.properties.test;
...
public class DefinePropertyGlobalTest extends AbstractTest {
    ...
    private final PropertiesV3Beta properties;
    ...
    public DefinePropertyGlobalTest(TestContext testContext, InstancesV3Beta instances, PropertiesV3Beta properties) {
        super(testContext);
