...
public class GetTypesForInvitation extends AbstractTest {
    ...
    public GetTypesForInvitation(TestContext testContext, boolean withProperties, boolean withIncomingLinks, TypesV3Beta types, String space, InstancesV3Beta instances) {
        super(testContext);
