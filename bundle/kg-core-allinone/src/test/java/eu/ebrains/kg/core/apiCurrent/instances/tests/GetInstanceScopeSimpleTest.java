...
public class GetInstanceScopeSimpleTest extends AbstractInstanceTest {
    ...
    public GetInstanceScopeSimpleTest(TestContext testContext, InstancesV3Beta instances) {
    ...
    @Override
    protected void run(){
        response = instances.getInstanceScope(testContext.getIdUtils().getUUID(originalInstance.id()), ExposedStage.IN_PROGRESS, false, false);
    }
}
