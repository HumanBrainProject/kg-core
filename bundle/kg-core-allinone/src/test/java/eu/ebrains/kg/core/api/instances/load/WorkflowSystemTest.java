...
public class WorkflowSystemTest extends AbstractInstancesLoadTest {
    ...
    public void testReleaseAndUnreleaseAndReReleaseInstance() throws IOException {
        ...
        ResponseEntity<Result<NormalizedJsonLd>> instance = instances.createNewInstance(payload, "test", DEFAULT_RESPONSE_CONFIG, DEFAULT_DEFER_INFERENCE);
    ...
    public void testInsertAndUpdateInstance() throws IOException {
        ...
        ResponseEntity<Result<NormalizedJsonLd>> resultResponseEntity = instances.contributeToInstancePartialReplacement(doc, idUtils.getUUID(id), false, DEFAULT_RESPONSE_CONFIG, DEFAULT_DEFER_INFERENCE);
