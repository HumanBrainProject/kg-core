...
public class ContributeToInstanceFullReplacementTest extends AbstractInstanceTest {
    ...
    public ContributeToInstanceFullReplacementTest(ArangoDB.Builder database, ToAuthentication authenticationSvc, IdUtils idUtils, Instances instances, RoleMapping[] roles) {
    ...
    @Override
    protected void run(){
       response = instances.contributeToInstanceFullReplacement(update, idUtils.getUUID(originalInstance.id()), false, defaultResponseConfiguration, defaultIngestConfiguration, null);
    }
