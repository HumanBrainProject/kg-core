...
public class ContributeToInstanceFullReplacementTest extends AbstractInstanceTest {
    ...
    @Override
    protected void run(){
       response = instances.contributeToInstanceFullReplacement(update, idUtils.getUUID(originalInstance.id()), defaultResponseConfiguration, defaultIngestConfiguration);
    }
